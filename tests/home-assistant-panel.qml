...
Shared.Theme {
  ...
  QtObject {
    ...
    property var entities: [
      ...
      {entity_id:"sensor.humidity",name:"Humidity",state:"46",unit:"%",room:"Office",favorite:false,available:true,controllable:false}
    ]
    ...
    function rows() { return [{heading:"Favorites"}, entities[0], {heading:"Office",detail:"21.4°C · 46%"}, entities[1], entities[2]] }
  ...
  Timer {
    ...
    onTriggered: {
      ...
      panel.grabToImage(function(result) {
        ...
        theme.stage++
        if (theme.stage === 1) { fixture.configured = true; panel.expanded = "light.desk" }
