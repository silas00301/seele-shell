...
const quietHandler = quietSource.slice(quietSource.indexOf('id: quietPresets')).match(/Keys.onPressed: event => \{([^]*?)\n                }/);
assert(quietHandler);
let quietStarts = 0;
...
vm.runInContext('function press(event) {' + quietHandler[1] + '}', quietContext);
