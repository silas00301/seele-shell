...
sed -i -e 's|import "../shared" as Shared|import "shared" as Shared|' \
  ...
  -e 's|../shared/ListModels.js|shared/ListModels.js|' "$work/production/TextWorkbenchPanel.qml"
...
PYTHON
cp "$fixture" "$work/tst_textworkbench.qml"
HOME="$work/home" XDG_CONFIG_HOME="$work/home" XDG_RUNTIME_DIR="$work/runtime" \
  ...
  -input "$work/tst_textworkbench.qml"
