...
pkgs.stdenvNoCC.mkDerivation {
  ...
  installPhase = ''
    ...
    install -m644 ${./ThemeSettingsPanel.qml} "$out/share/seele-shell/ThemeSettingsPanel.qml"
    substituteInPlace "$out/share/seele-shell/ThemeSettingsPanel.qml" --replace-fail 'import "../shared" as Shared' 'import "shared" as Shared'
  ...
  installCheckPhase = ''
    ...
    node ${tests}/themes.js "$out/share/seele-shell/ThemeStore.qml" "$out/share/seele-shell/ThemePanel.qml" "$out/share/seele-shell/shell.qml" "$out/share/seele-shell/ThemeSettingsPanel.qml"
