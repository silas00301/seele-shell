...
function customInput(input) { return Bridge.call("focus.customInput", [input]) }
function extensionHint(state) { return Bridge.call("focus.extensionHint", [state]) }
function canExtend(state) { return Bridge.call("focus.canExtend", [state]) }
